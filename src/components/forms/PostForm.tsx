    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-9 w-full max-w-5xl">
      ...
      />
       <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className='shad-form_label'>Add tags (sepreated by comma ',')</FormLabel>
            <FormControl>
                <Input type='text' className='shad-input' placeholder='Js React etc' {...field} />
            </FormControl>
            <FormMessage className='shad-form_message' />
          </FormItem>
        )}
